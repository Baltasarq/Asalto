   ...
   2 REM baltasarq@yahoo.es
   3 POKE &bdee,&c9 : MODE 1: INK 0,0: INK 1,26: INK 2,24: INK 3,23 : GO SUB 9998
   4 PEN 2: LOCATE 12,3:PRINT "Asalto y castigo": PEN 1: LOCATE 11,12:PRINT "baltasarq@yahoo.es": LOCATE 8,13:PRINT "http://caad.es/baltasarq/"
   5 PEN 3: LOCATE 16,17:PRINT "C.A.A.D.": LOCATE 11,18:PRINT "http://www.caad.es/": LOCATE 1,23:GO SUB 9965
   7 LET Cols=40
  10 GO SUB 9998
  12 LET t$="El sol despunta de entre la niebla, haciendo humear los tejados de paja.": GO SUB 9850: GO SUB 9970: PRINT
  14 LET t$="Piensas en el encargo realizado por Uther Pendragon. Atacar una aldea tranquila, aunque sea una llena de sajones, no te llena de orgullo.": GO SUB 9850
  16 LET loc=1: LET sig=0: LET trSax=0: LET hablado=0: LET acc=-1: LET uno=-1: LET otro=-1: LET cortado=0: LET j$="No lo veo, o no es importante.":LET chrA=ASC("A"): LET chrZ=ASC("Z"): LET diff=ABS (ASC("a")-chrA)
18 LET k$="Direcciones: n(orte), s(ur), e(ste), o(este), arriba, abajo. (M)irar redescribe un lugar, (ex)aminar permite examinar un objeto, o, al no indicar nada, a ti. Se puede cortar, nadar, atacar, empujar o golpear algo, cogerlo, dejarlo, y tirarlo."
  20 GO SUB 500: GO SUB 9970: PRINT : LET t$="Los hombres se ciernen sobre la aldea, y la destruyen. No hubo tropas enemigas, ni honor en la batalla.": GO SUB 9850
  25 GO SUB 5000: GO SUB 9960
  30 gosub 9998 : LET t$="- Sire Ulfius, la batalla ha terminado.": GO SUB 9840
  35 GO SUB 5136
...
2010 IF o(n,1)=loc AND o(n,2)=2 THEN LET t$=t$+"  - "+CHR$(ASC(left$(n$(n),1))-diff)+right$(n$(n),len(n$(n))-1)+CHR$(13)+CHR$(10): GO TO 2035
2015 IF o(n,1)=loc THEN LET t$=t$+"  - "+n$(n)+CHR$ (13)+chr$(10)
2035 NEXT n
...
2510 IF loc=16 THEN LET m$="En la distancia, por entre los resquicios de las rocas, y allende el canal de agua, los sajones tratan de buscar la salida que encontraste por casualidad."
...
2999 RETURN
3000 REM proc2
3010 IF loc<>8 OR d(8,1)=0 THEN goto 3100
3015 LET d(8,1)=0:LET trSax=1: LET t$="Una partida sajona aparece por el este. Para cuando te vuelves al norte, ya no te queda ninguna duda: era una trampa.": GO SUB 9850: GO SUB 9960
3020 PRINT : LET t$="En el estrecho paso es posible resistir, aunque por desgracia sus efectivos son muy superiores a los tuyos.": GO SUB 9850: GO SUB 9970: GO SUB 9998
3025 LET t$="Tus oficiales te conminan a huir. Capturando a un general britano, ganan doblemente. Sabes que es cierto, y te duele.": GO SUB 9840: PRINT : GO SUB 9970
3100 IF trSax>0 AND loc<12 THEN LET trSax=trSax+1: LET t$="No sabes cuanto tiempo te queda ...": GO SUB 9850: PRINT
3200 IF trSax>10 AND loc<12 THEN LET t$="Los sajones te capturan. Su general, sonriendo ampliamente, dice: 'bien, bien'. Del gran Ulfius podremos sacar una buena ventaja.": GO SUB 9840: GO SUB 9960: let acc=17:goto 7000
3300 IF loc<10 AND d(8,1)=0 THEN LET t$="Tus hombres luchan con denuedo contra los sajones.": PRINT : GO SUB 9850
3400 LET obj=4: GO SUB 1000: IF loc>19 AND aqui=0 THEN LET t$="Ante la reinante e intimidante oscuridad, retrocedes a donde puedes ver.": GO SUB 9850: GO SUB 9960: LET loc=17: GO SUB 9998: GO SUB 9980: RETURN
3500 IF loc<>51 THEN goto 4999
3505 LET t$="Agotado, das parte en el castillo de tu llegada y de lo que ha pasado.": GO SUB 9850: GO SUB 9970: PRINT
3510 LET t$="Pides audiencia al rey, Uther Pendragon.": GO SUB 9850: GO SUB 9960: GO SUB 9998
3515 LET t$="El rey, te indica el valido, ha ordenado que no se le moleste, pues sufre una amarga tristeza.": GO SUB 9840: GO SUB 9970
3520 PRINT : LET t$="No puedes entenderlo. El rey, tu amigo.": GO SUB 9850: GO SUB 9970
3525 PRINT : LET t$="Agotado, decepcionado, apesadumbrado, decides ir a dormir a tu casa. Es lo poco que puedes hacer.": GO SUB 9850: GO SUB 9960
3530 LET t$="Te HAS GANADO un buen descanso": PRINT : GO SUB 9850: PRINT : LET acc=17: GO TO 7000
4999 RETURN
5000 REM locs
...
5109 DATA "Explanada. Una gran explanada enlosetada contempla un bello panorama de estalactitas. Unos casi imperceptibles escalones conducen al este."
...
7050 IF acc=17 THEN LET m$="Volver a intentarlo (S/N):": GO SUB 9940: IF left$(m$,1)="n" OR left$(m$,1)="N" THEN gosub 9998: NEW
7052 RUN
...
7115 IF acc<>6 OR loc<>11 THEN goto 7150
7120 LET loc=12: LET t$="Caes hacia el fondo por el peso de tu coraza. Como puedes, te desprendes de ella y buceas, pensando en avanzar, aunque perdido.": GO SUB 9850: GO SUB 9960
7130 PRINT : LET t$="Consigues emerger, si bien en un sitio desconocido de la caverna ...": GO SUB 9850: GO SUB 9960: GO SUB 9998: GO SUB 9980: RETURN
7150 IF acc=6 THEN LET t$="No tiene sentido nadar ahora.": GO SUB 9850: RETURN
7160 IF acc=4 THEN GO SUB 7530: RETURN
7170 IF acc=11 THEN GO SUB 7600: RETURN
7180 IF acc=18 THEN GO SUB 7700: RETURN
7190 IF acc<>2 OR loc<>47 THEN goto 7250
7200 LET obj=16: GO SUB 1000: IF aqui<>1 THEN goto 7250 
7210 LET t$="La puerta se abre, rechinando, mientras hiedras y hierbas se rompen en su trazado.": GO SUB 9850: GO SUB 9970: PRINT
7220 LET t$="Ambrosio, alegre, se despide de ti. 'Estoy seguro de que volveremos a vernos', dice. Se ha ido.": GO SUB 9840
7230 LET o(2,1)=255: LET o(16,1)=255: LET o$(19)="Entreabierta.": LET d(47,4)=48: RETURN
7250 IF acc=2 AND loc=47 THEN LET t$="El candado bloquea la puerta.": GO SUB 9850: RETURN
7260 IF acc=2 THEN LET t$="No hay nada que abrir ahora.": GO SUB 9850: RETURN
7270 IF acc=12 THEN GO SUB 7715: RETURN
...
7535 GO SUB 1000
7536 IF uno=22 and otro=10 and cortado=0 and n<>1 and aqui=1 THEN LET t$="Sabes que el resultado es la hoja de tu espada, mellada. No.": GO SUB 9850: RETURN
7537 IF uno=22 and otro=17 and cortado=0 and aqui=1 THEN LET cortado=1:LET t$="Con el pedernal, recortas la punta del tronco.": GO SUB 9850: RETURN
...
7542 IF uno=20 AND otro=22 AND aqui=1 AND n=0 AND cortado=1 THEN LET o(20,1)=255: LET d(31,1)=32: LET t$="Haciendo palanca, consigues desencajar una, y el resto caen por su propio peso.": GO SUB 9850: RETURN
...
7555 LET obj=3: GO SUB 1000: IF uno<>17 or otro<>10 or aqui<>1 THEN goto 7560
7557 LET o(3,1)=255: LET o(4,1)=loc: LET n$(3)="amorfa": LET n$(4)="antorcha": LET t$="Poderosas chispas salen del choque entre espada y pedernal, encendiendo la antorcha.": GO SUB 9850: RETURN
...
7605 LET o(3,1)=0: LET o(17,1)=0: LET o(2,1)=46: LET t$="- Hola, buen hombre.": GO SUB 9840: LET t$="- Hola, Ulfius. Mi nombre es Ambrosio.": GO SUB 9840: GO SUB 9960: PRINT
7610 LET t$="Por primera vez, Ulfius se sienta y cuenta a Ambrosio todo lo que ha pasado. Y tras tanto acontecido, llora desconsoladamente.": GO SUB 9850: GO SUB 9970: GO SUB 9998
7615 LET t$="Ambrosio le propone un trato, que acepta: por ayudarle a salir de la cueva, objetos, vitales para la empresa, le son entregados.": GO SUB 9850: GO SUB 9970: PRINT : LET t$="- Bien, Ambrosio, emprendamos la marcha.": GO SUB 9840: PRINT
7620 LET t$="Ulfius se da la vuelta para ver si Ambrosio le sigue, pero ... ha desaparecido.": GO SUB 9850: GO SUB 9970: PRINT : LET t$="Ulfius piensa entonces en el hecho curioso de que supiera su nombre.": GO SUB 9850: GO SUB 9960: RETURN
7625 IF loc<>46 or sig<>0 THEN goto 7655
7630 LET t$="- La llave, Ambrosio, estaba ya en tu poder. Y es obvio que conoceis un camino mas corto.": GO SUB 9840
7635 LET t$="- Estoy atrapado en la cueva debido a magia de maligno poder. En cuanto al camino, vos debeis hacer el vuestro, verlo todo con vuestros ojos.": GO SUB 9840: LET t$="Ulfius sacude la cabeza.": GO SUB 9850
7640 LET t$="- No lo entiendo, la verdad.": GO SUB 9840
7655 IF loc>=45 AND loc<=47 THEN LET t$="- Por favor, Ulfius, cumple tu promesa. Toma la llave en tu mano y abre la puerta de la cueva.": LET o(16,1)=0: LET o(16,2)=0: LET sig=1: GO SUB 9840: RETURN
7660 IF uno=13 THEN GO SUB 7670: RETURN
7665 LET t$="No tiene sentido hablar con eso.": GO SUB 9850: RETURN
7670 IF hablado=0 THEN LET t$="- Me llamo Ulfius y ...": GO SUB 9840: LET t$="El hombre asiente, impaciente.": GO SUB 9850: LET t$="- Somos refugiados de la gran guerra. Buscamos la paz.": GO SUB 9840
7680 LET hablado=1
7685 LET obj=18: GO SUB 1000: IF aqui<>1 THEN goto 7697
7687 LET o(18,1)=18: LET t$="El hombre se irrita.": GO SUB 9850: LET t$="- No podemos permitiros huir con la piedra del druida.": GO SUB 9840: LET t$="Hace un gesto...": GO SUB 9850
7690 LET t$="- La piedra debe devolverse a su lugar de encierro.": GO SUB 9840: LET t$="Un hombre te arrebata la piedra y se la lleva.": GO SUB 9850: RETURN
7697 LET obj=10: GO SUB 1000: IF aqui=1 THEN LET t$="El hombre se enfurece, y alza su mano indicando al norte.": GO SUB 9850: LET t$="- Nadie portando armas puede pasar.": GO SUB 9840: RETURN
7699 LET d(28,3)=29: LET t$="El hombre, calmado, indica hacia el este y habla:": GO SUB 9850: LET t$="- Si vienes en paz, puedes ir en paz.": GO SUB 9840: LET t$="Todos se apartan y permiten ahora el paso al este.": RETURN
7700 REM tira
...
8015 IF j<=l AND mid$(t$,j,1)=" " THEN LET j=j+1: GO TO 8015
8025 IF l>1 AND mid$(t$,l,1)=" " THEN LET l=l-1: GO TO 8025
8030 IF j>l THEN GO TO 8080
8035 LET chrAsc=ASC(MID$(t$,j,1))
8040 IF chrAsc>=chrA AND chrAsc<=chrZ THEN LET chrAsc=diff+chrAsc
8045 IF chrAsc<>ASC(" ") THEN LET m$=m$+CHR$(chrAsc): GO TO 8070
8050 GO SUB 8090
8055 IF otro<>-1 THEN GO TO 8085
8065 IF mid$(t$,j,1)=" " THEN LET j=j+1: GO TO 8065
8067 GO TO 8030
8070 LET j=j+1
8075 GO TO 8030
8080 GO SUB 8090
...
9860 IF i<n AND mid$(t$,i,1)=" " THEN LET i=i+1: LET f=f+1: GO TO 9860
9862 IF f>n THEN LET f=n: GO TO 9870
9865 IF f>1 AND mid$(t$,f,1)<>" " THEN LET f=f-1: GO TO 9865
9870 PRINT mid$(t$,i,f-i)
9875 IF f<n THEN LET i=f+1: LET f=f+Cols: GO TO 9860
9880 LET t$="": PEN 1: RETURN
9940 REM siNo()
9942 print m$;:INPUT " ", m$
9944 IF LEN(m$)=0 THEN GO TO 9942
9946 IF left$(m$,1)=" " THEN GO TO 9942
9948 LET m$=left$(m$,1)
9950 RETURN
9960 REM Puntos
9965 PEN 3:PRINT:PRINT "...":PRINT
9970 REM pausa
9972 IF INKEY$<>"" THEN GO TO 9972
9974 IF INKEY$="" THEN GO TO 9974
9976 PEN 1:RETURN
9980 REM mira
9982 GO SUB 2500: LOCATE 1,2:LET t$=h$(loc): GO SUB 9830
9984 IF m$<>"" THEN LET t$=m$: LET m$="": PRINT : GO SUB 9850
9986 PRINT : GO SUB 2000: RETURN
9995 REM input
9996 PEN 2: INPUT "> ", t$: IF t$="" THEN GO TO 9996
9997 PEN 1: RETURN
9998 BORDER 0: PAPER 0: PEN 1: CLS : RETURN
